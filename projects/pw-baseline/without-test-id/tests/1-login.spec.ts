...
test.describe('Login Page', () => {
    ...
    test('should verify app is running WITHOUT data-testid attributes', async ({ page }) => {
        // Verify that the sample app is running WITHOUT test IDs
    ...
    test('should display login form with all required elements', async ({ page }) => {
        // Verify form elements exist using input type selectors
    ...
    test('should successfully login with valid user credentials', async ({ page }) => {
        // Fill email by input type
        await page.locator('input[type="email"]').fill('user@example.com');

        // Fill password by input type
    ...
    test('should show error message with invalid credentials', async ({ page }) => {
        ...
        // Wait for error message to appear (by id or class)
